...
namespace geeL {
	...
	public:
		...
		void addTexture(std::shared_ptr<TextureMap> texture);
		void addTextures(std::vector<std::shared_ptr<TextureMap>> textures);
		void addTexture(const MapType& type, std::shared_ptr<Texture2D> texture);
