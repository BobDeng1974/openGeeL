...
namespace geeL {
	...
	void SSRR::init(ScreenQuad& screen, IFrameBuffer& buffer, const Resolution& resolution) {
	...
	void MultisampledSSRR::init(ScreenQuad & screen, IFrameBuffer& buffer, const Resolution& resolution) {
